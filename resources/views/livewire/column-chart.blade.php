      ...
      series: [
        {
          ...
          color: "#FEF9C3",
          data: [
            { x: "January", y: {{$pending['January']}} },
            { x: "February", y: {{$pending['February']}} },
            { x: "March", y: {{$pending['March']}} },
            { x: "April", y: {{$pending['April']}} },
            { x: "May", y: {{$pending['May']}} },
        ...
        },
        {
          ...
          color: "#EF4444",
          data: [
            { x: "January", y: {{$denied['January']}} },
            { x: "February", y: {{$denied['February']}} },
            { x: "March", y: {{$denied['March']}} },
            { x: "April", y: {{$denied['April']}} },
            { x: "May", y: {{$denied['May']}} },
        ...
        },
        {
          ...
          color: "#22C55E",
          data: [
            { x: "January", y: {{$accepted['January']}} },
            { x: "February", y: {{$accepted['February']}} },
            { x: "March", y: {{$accepted['March']}} },
            { x: "April", y: {{$accepted['April']}} },
            { x: "May", y: {{$accepted['May']}} },
