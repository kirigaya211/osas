                  ...
                  <div class="flex space-x-4">
                    ...
                    <span class="bg-orange-100 hover:bg-gray-100 hover:border-black text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-1 rounded-md dark:bg-green-900 dark:text-green-300">
                      <button data-modal-target="crud-modal" data-modal-toggle="crud-modal"
                        class="uppercase text-sm font-semibold inline-flex items-center rounded-lg text-blue-white hover:text-white-700 dark:hover:white-blue-500 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 px-3 py-2" type="button">
                        GENERATE REPORT
                      </button>
      ...
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <form action="{{ route('data-export.index') }}" method="GET" class="p-4 md:p-5">
            @csrf 
              ...
              <div class="mb-6">
                  <label for="fileType" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select File Type</label>
                  <select id="fileType" name="fileType" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
